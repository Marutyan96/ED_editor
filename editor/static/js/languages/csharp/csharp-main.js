// js/languages/csharp/csharp-main.js

export function initCSharpEditor() {
    ...
    const ws = new WebSocket(`ws://${window.location.host}/ws/csharp/`);
...
// Для совместимости
window.initCSharpEditor = initCSharpEditor;